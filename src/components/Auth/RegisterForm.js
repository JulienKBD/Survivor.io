...
export default function RegisterForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const authResponse = await fetch(`${process.env.REACT_APP_API_URL}/auth/register`, {
        method: "POST",
      ...
      if (role === "investor") {
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/investors`, {
          method: "POST",
          headers: {
      ...
      if (role === "founder") {
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/startups`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${authResult.token}`,
